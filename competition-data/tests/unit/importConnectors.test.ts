...
describe("import connectors", () => {
  ...
  it("imports .xlsx results", async () => {
    ...
    sheet.addRow(["event_name", "start_date", "country", "venue", "class_name", "horse_name", "horse_reg", "rider_name", "rider_member", "start_number", "final_score", "final_place", "status"]);
    sheet.addRow(["XLSX Horse Trials", "2026-07-01", "AU", "Excel Park", "EvA80", "Excel Horse", "EH1", "Excel Rider", "ER1", "1", "30.1", "1", "placed"]);
